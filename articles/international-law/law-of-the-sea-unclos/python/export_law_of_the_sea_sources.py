#!/usr/bin/env python3
"""
Export Law of the Sea / UNCLOS metadata into Markdown for editorial review.
"""
...
def export_markdown() -> None:
    ...
    concepts = read_csv(ARTICLE_DIR / "data" / "law_of_the_sea_concepts.csv")

    lines = ["# Law of the Sea / UNCLOS — Source Export", ""]
    ...
    lines.extend(["", "## Law of the Sea Concepts", ""])
    for row in concepts:
        lines.append(
    ...
    output = OUTPUT_DIR / "law_of_the_sea_sources_export.md"
    output.write_text("\n".join(lines) + "\n", encoding="utf-8")
