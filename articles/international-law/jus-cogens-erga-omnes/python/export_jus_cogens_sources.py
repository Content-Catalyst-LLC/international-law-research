#!/usr/bin/env python3
"""
Export Jus Cogens and Erga Omnes metadata into Markdown for editorial review.
"""
...
def export_markdown() -> None:
    ...
    concepts = read_csv(ARTICLE_DIR / "data" / "jus_cogens_concepts.csv")

    lines = ["# Jus Cogens and Erga Omnes — Source Export", ""]
    ...
    lines.extend(["", "## Jus Cogens and Erga Omnes Concepts", ""])
    for row in concepts:
        lines.append(
    ...
    output = OUTPUT_DIR / "jus_cogens_sources_export.md"
    output.write_text("\n".join(lines) + "\n", encoding="utf-8")
