#!/usr/bin/env python3
"""
Export International Courts and Tribunals metadata into Markdown for editorial review.
"""
...
def export_markdown() -> None:
    ...
    concepts = read_csv(ARTICLE_DIR / "data" / "adjudication_concepts.csv")

    lines = ["# International Courts and Tribunals — Source Export", ""]
    ...
    lines.extend(["", "## Adjudication Concepts", ""])
    for row in concepts:
        lines.append(
    ...
    output = OUTPUT_DIR / "adjudication_sources_export.md"
    output.write_text("\n".join(lines) + "\n", encoding="utf-8")
