...
def export_markdown() -> None:
    ...
    lines = ["# Public vs Private International Law — Source Export", ""]
    lines.extend(["## Primary Authorities and Institutions", ""])
    for row in primary:
    ...
    output = OUTPUT_DIR / "public_private_sources_export.md"
    output.write_text("\n".join(lines) + "\n", encoding="utf-8")
