#!/usr/bin/env python3
"""
Export General Principles of Law metadata into Markdown for editorial review.
"""
...
def export_markdown() -> None:
    ...
    concepts = read_csv(ARTICLE_DIR / "data" / "general_principles_concepts.csv")

    lines = ["# General Principles of Law — Source Export", ""]
    ...
    lines.extend(["", "## General-Principles Concepts", ""])
    for row in concepts:
        lines.append(
    ...
    output = OUTPUT_DIR / "general_principles_sources_export.md"
    output.write_text("\n".join(lines) + "\n", encoding="utf-8")
