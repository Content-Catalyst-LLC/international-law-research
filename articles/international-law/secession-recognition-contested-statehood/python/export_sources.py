...
lines = ["# Secession, Recognition, and Contested Statehood — Source Export", ""]
...
lines.append("")
lines.append("## Contested Statehood Examples")
for row in rows("contested_statehood_examples.csv"):
    lines.append(f"- **{row['entity']}** — {row['issue']} ({row['legal_frame']})")
