#!/usr/bin/env python3
"""
Export Fragmentation and Coherence metadata into Markdown for editorial review.
"""
...
def export_markdown() -> None:
    ...
    concepts = read_csv(ARTICLE_DIR / "data" / "fragmentation_concepts.csv")

    lines = ["# Fragmentation and Coherence — Source Export", ""]
    ...
    lines.extend(["", "## Fragmentation and Coherence Concepts", ""])
    for row in concepts:
        lines.append(
    ...
    output = OUTPUT_DIR / "fragmentation_sources_export.md"
    output.write_text("\n".join(lines) + "\n", encoding="utf-8")
